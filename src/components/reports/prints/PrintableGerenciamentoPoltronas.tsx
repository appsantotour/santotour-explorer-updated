...
interface PrintableGerenciamentoPoltronasProps {
  passengers: PassengerSeatDataPrint[];
  nomeViagem: string;
  dataViagem: string; // Assumed DD/MM/AAAA
}

const PrintableGerenciamentoPoltronas: React.FC<PrintableGerenciamentoPoltronasProps> = ({ passengers, nomeViagem, dataViagem }) => {
  return (
...
export default PrintableGerenciamentoPoltronas;